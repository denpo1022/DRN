...
parser.add_argument(
    "--data_dir", type=str, default="data_path", help="dataset directory"
)
...
parser.add_argument("--patch_size", type=int, default=384, help="output patch size")
...
parser.add_argument(
    "--pre_train_dual", type=str, default=".", help="pre-trained dual model directory"
)
parser.add_argument(
    "--n_blocks", type=int, default=30, help="number of residual blocks, 16|30|40|80"
)
parser.add_argument("--n_feats", type=int, default=16, help="number of feature maps")
parser.add_argument(
    "--negval", type=float, default=0.2, help="Negative value parameter for Leaky ReLU"
)
parser.add_argument(
...
parser.add_argument("--eta_min", type=float, default=1e-7, help="eta_min lr")
...
parser.add_argument(
    "--loss", type=str, default="1*L1", help="loss function configuration, L1|MSE"
)
parser.add_argument(
    "--skip_threshold",
    type=float,
...
parser.add_argument(
    "--dual_weight", type=float, default=0.1, help="the weight of dual loss"
)
parser.add_argument(
    "--save", type=str, default="./experiment/test/", help="file name to save"
)
parser.add_argument(
    "--print_every",
    type=int,
